...
## Project Structure
    ...
    ├── testapiautocatalog_105346  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_105346`
...
2. Clone this repo and `cd testapiautocatalog_105346`
